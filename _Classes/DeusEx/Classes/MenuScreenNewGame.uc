...
defaultproperties
{
     ...
     CheckboxTipText="'Original Morpheus' reverts to his old voiceover. 'Original interactions' reverts to the old dialogue for Mercedes, Camille, Mamasan, and CanalWhore."
     ...
     actionButtons(3)=(Align=HALIGN_Right,Action=AB_Other,Text="|&Help",Key="HELP")
